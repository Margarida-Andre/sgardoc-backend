    ...
    try {
      ...
      if (declaracoesPendentes == 0) {
        return res.status(400).json({
          message:
            "Não existe nenhuma solicitação de declaração de estudo pendente",
        });
      }
  ...
  async getDeclaracoesAprovadas(req, res) {
    try {
      ...
      if (declaracoesAprovadas == 0) {
        return res.status(400).json({
          message:
            "Não existe nenhuma solicitação de declaração de estudo aprovada",
        });
      }
  ...
  async getDeclaracoesRejeitadas(req, res) {
    try {
      ...
      if (declaracoesRejeitadas == 0) {
        return res.status(400).json({
          message:
            "Não existe nenhuma solicitação de declaração de estudo rejeitada",
        });
      }
  ...
  async createSolicitacao(req, res) {
    try {
      ...
      return res.json({
        solicitacaoCreate,
        message:
          "Solicitação de estudos com sucesso, um email será enviado ao destinatário após solicitação ser aprovada.",
      });
    } catch (error) {
      res.json(error);
    }
